import ClientProjectsMetricValue from './ClientProjectsMetricValue';

function ClientProjectsMetric() {
  return (
    <div
      ...
      data-component-id="ClientProjectsMetric"
    >
      <ClientProjectsMetricValue />
...
export default ClientProjectsMetric;
