function ProcessEyebrow() {
  return (
    <div
      className="w-[30%] h-min relative flex flex-col shrink-0 justify-start content-start items-start gap-y-4 gap-x-4"
      data-component-id="ProcessEyebrow"
    >
