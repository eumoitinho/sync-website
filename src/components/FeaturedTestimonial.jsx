function FeaturedTestimonial() {
  return (
    <div
      className="w-full max-w-[1440px] aspect-[1.7_/_1] relative flex overflow-x-hidden overflow-y-hidden flex-col shrink-0 justify-end content-start items-start gap-y-6 gap-x-6 p-[60px] rounded-br-[16px] rounded-t-[16px] rounded-bl-[16px]"
      data-component-id="FeaturedTestimonial"
    >
      ...
      <div className="contents">
        <div className="js-parallax opacity-100 absolute top-[-100px] bottom-[-100px] z-[1] shrink-0 will-change-transform translate-x-0 translate-y-[56.44px] inset-x-0">
          <div className="absolute inset-0">
            <img
              width="1920"
              height="1280"
              src="https://framerusercontent.com/images/MkXrXOEtMltDBk3zvP3qIz52y4.jpg"
              alt="equipe colaborando no escritorio da Sync"
              className="object-[center_center] w-full h-full aspect-[auto_1920_/_1280] block object-cover"
            />
          </div>
          <div className="bg-[rgba(5,8,20,0.22)] absolute overflow-x-hidden overflow-y-hidden shrink-0 inset-0"></div>
        </div>
      </div>
    </div>
  );
